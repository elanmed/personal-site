...
abstract: "How I made my frecency-based fuzzy finder fast enough to actually use"
lastUpdated: "Dec 17, 2027"
slug: fuzzy-finder-lessons-in-performance
tags:
  - software eng
  - vim
collection: null
...
> tl;dr I built my own fuzzy finder called [`ff.nvim`](https://github.com/elanmed/ff.nvim)
...
started work on [`ff.nvim`](https://github.com/elanmed/ff.nvim) - I figured it would be a bit more
