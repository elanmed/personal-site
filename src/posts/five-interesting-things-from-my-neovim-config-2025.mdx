...
a handful of tips I came up with when moving from VSCode to Neovim. It's been a few years since, my
config has changed quite a bit, and I like to think my vim knowledge has grown. So - it's time for a
sequel!
