...
<Info>
  In 2024, MagicDuck
  [announced](https://www.reddit.com/r/neovim/comments/1co755r/grugfarnvim_new_take_on_find_and_replace_as_a/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button)
  a plugin called [grug-far](https://github.com/MagicDuck/grug-far.nvim) that acts as an
  interactive, global find and replace interface for Neovim. It's amazing, I'd recommend testing it
  out as a much more feature-complete version of the solution in this article.
</Info>
